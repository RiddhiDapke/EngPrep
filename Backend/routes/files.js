...
// // 🟢 API to Fetch Files Based on Filters (Subject, Year, Branch)
...
//     // Case-insensitive filtering using regex with 'i' flag
...
//     const newFile = new File({ title, subject, year, branch, semester, cloudinary_url });
//     await newFile.save();
